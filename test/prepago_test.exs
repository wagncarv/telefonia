defmodule PrepagoTest do
  ...
  describe "fazer_chamada/3" do
    test "fazer uma chamada" do
      ...
      assert Prepago.fazer_chamada("12", DateTime.utc_now(), 3) ==
               {:ok, "A chamada custou 4.35. Agora você tem 5.65 de créditos"}
    end

    test "fazer uma chamada longa sem ter créditos" do
      Assinante.cadastrar("Kang", "12", "123", :prepago)

      assert Prepago.fazer_chamada("12", DateTime.utc_now(), 10) ==
